...
class KafkaStack(core.Stack):
    def __init__(
        ...
        if client == True:
            ...
            kafka_client_userdata = user_data_init(log_group_name="fk/kafka/instance")
            # create the instance
            ...
            kafka_client_userdata.add_commands(
                ...
                # create the topics
                f"make_topic=`/opt/{constants['KAFKA_DOWNLOAD_VERSION']}/bin/kafka-topics.sh --create --zookeeper $kafka_zookeeper --replication-factor 3 --partitions 1 --topic fktopic 2>&1`",
